...
class WaveUNet(nn.Module):
    def __init__(self, num_layers=10, num_initial_filters=16, kernel_size=5, 
...
class MUSDB18Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        vocals = torch.tensor(track.targets['drums'].audio.T, dtype=torch.float32)
...
def main():
    ...
    checkpoint_path = './checkpoints/checkpoint_epoch_70.pt'  # Change this as needed
